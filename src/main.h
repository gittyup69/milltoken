...
static const unsigned int MAX_BLOCK_SIZE = 7000;                      // 7KB block hard limit
/** Obsolete: maximum size for mined blocks */
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/4;         // 1.75KB  block soft limit
/** Default for -blockmaxsize, maximum size for mined blocks **/
static const unsigned int DEFAULT_BLOCK_MAX_SIZE = 1750;
/** Default for -blockprioritysize, maximum space for zero/low-fee transactions **/
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 800;
/** The maximum size for transactions we're willing to relay/mine */
static const unsigned int MAX_STANDARD_TX_SIZE = 1400;
...
static const int64 DUST_SOFT_LIMIT = 900000; // 0.009 MLT
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 50000;   // 0.0005 MLT mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 788400000 * COIN;
